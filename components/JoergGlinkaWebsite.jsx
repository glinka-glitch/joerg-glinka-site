...
<div className="absolute -z-10 bottom-[-120px] left-[20%] w-[280px] h-[280px] bg-fuchsia-500/10 blur-[20px] rounded-full"></div>
      ...
      {/* Hero */}
      <section className="relative isolate px-4 md:px-6 pt-6 md:pt-16 pb-20 md:pb-24">
...
<Image
  src={`${blok?.hero_image?.filename}/m/700x700`}
  alt="Jörg Glinka"
  width={700}
  height={700}
  ...
  priority
  fetchPriority="high"
  className="relative rounded-3xl object-cover h-[380px] sm:h-[450px] md:h-[550px] lg:h-[650px] w-full"
/>
</div>
